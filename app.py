...
def misalignment_api():
    ...
    for t in sorted(MISALIGNMENT):
        results.append({'topic':t, 'data':{l:{'num_articles':MISALIGNMENT[t][l][0], 'misalignment':f'{MISALIGNMENT[t][l][1]:.3f}'} for l in langs}})
...
def load_misalignment_data():
    ...
    expected_header = ['topic', 'wiki_db', 'num_articles', 'avg_misalignment']
